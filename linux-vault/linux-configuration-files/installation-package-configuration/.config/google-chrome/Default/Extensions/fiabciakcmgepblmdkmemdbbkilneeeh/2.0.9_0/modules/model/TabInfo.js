...
class TabInfo {
    ...
    _markedForLoadSuspended;
    _originalUrlBeforeSuspend;
    constructor(tab) {
        this._id = tab.id;
    ...
    get markedForLoadSuspended() {
        return this._markedForLoadSuspended;
    }
    set markedForLoadSuspended(value) {
    ...
    get originalUrlBeforeSuspend() {
        return this._originalUrlBeforeSuspend;
    }
    set originalUrlBeforeSuspend(value) {
