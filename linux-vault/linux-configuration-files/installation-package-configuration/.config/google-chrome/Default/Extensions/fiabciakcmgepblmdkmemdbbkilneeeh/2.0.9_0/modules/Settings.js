...
function GET_SETTINGS_TYPE(key) {
...
class Settings {
    ...
    exceptionPatterns;
    exceptionPatternsV2;
    tabIconOpacityChange;
    animateTabIconSuspendTimeout;
    tabIconStatusVisualize;
    restoreTabOnStartup;
    parkBgColor;
    autoSuspendOnlyOnBatteryOnly;
    startDiscarted;
    startNormalTabsDiscarted;
    screenshotQuality;
    discardTabAfterSuspendWithTimeout;
    discardTimeoutFactor;
    openUnfocusedTabDiscarded;
    enableSuspendOnlyIfBattLvlLessValue;
    battLvlLessValue;
    screenshotCssStyle;
    adaptiveSuspendTimeout;
    restoreButtonView;
    sendErrors;
    ignoreCloseGroupedTabs;
    ignoreSuspendGroupedTabs;
    screenshotsEnabled;
    popup_showWindowSessionByDefault;
    suspendOnCtrlClick;
    suspendOnCtrlClick_hotfix_migrated;
    // v2.0.0
    localStorageMigrated;
    localStorageFormDataCleaned;
}
...
if (typeof global !== "undefined") {
    ...
    global.SETTINGS_TYPES = SETTINGS_TYPES;
    global.GET_SETTINGS_TYPE = GET_SETTINGS_TYPE;
    global.NUMBER_TYPE = NUMBER_TYPE;
    global.STRING_TYPE = STRING_TYPE;
    global.BOOLEAN_TYPE = BOOLEAN_TYPE;
}
