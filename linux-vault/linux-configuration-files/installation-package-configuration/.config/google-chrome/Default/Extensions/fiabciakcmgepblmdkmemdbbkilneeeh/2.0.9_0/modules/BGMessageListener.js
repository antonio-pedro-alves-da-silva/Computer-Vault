...
class BGMessageListener {
    ...
    BASE64_SEPARATOR_LENGTH = this.BASE64_SEPARATOR.length;
    constructor(tabManager) {
        ...
        chrome.runtime.onMessage.addListener(/* DO NOT ADD async HERE IT BROKE sendResponse??*/ (request, sender, sendResponse) => {
            ...
            if (typeof request == 'string') {
                ...
                if (request.battery.isCharging != null)
                    isCharging = request.battery.isCharging;
                if (request.battery.level != null)
                    batteryLevel = request.battery.level;
...
//# sourceMappingURL=BGMessageListener.js.map