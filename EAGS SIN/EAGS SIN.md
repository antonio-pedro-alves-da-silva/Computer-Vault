LINGUA PORTUGUESA
	...
	GRAMÁTICA
			...
			encontro vocálicos
				classificação
					hiato
						...
						vogal + vogal 
							álc**coo**l
					[ditongo](https://www.todamateria.com.br/ditongo/)
					![[Pasted image 20230904220239.png]]
					[ditongo oral crescente e ditongo oral decrescente](https://www.todamateria.com.br/ditongo/)
					[o que é uma semivogal ?](https://www.youtube.com/watch?v=WGDq8jY4Rzk)
						1.elas são representadas pelo fonemas /i/ e /u/
						2.são os fonemas que se juntam a uma vogal, formando com esta uma só sílaba. Exemplos: couro, baile.
		...
		Morfologia
			...
			classes de palavras
					...
					flexão
						...
						grau
							...
							superlativo relativo
								ele eleva SUPERIORIZA OU INFERIORIZA algo em relação a um conjunto
								superioridade
							...
							superlativo absoluto
								...
								analítico
									...
									O superlativo analítico é formado a partir do acréscimo de palavras como _super, muito, extremamente_ ,mais e _extraordinariamente_. Veja só alguns exemplos
									exemplo : o menino é o mais atencioso
									exemplo: o menino é muito atencioso
									exemplo:o menino é extremamente atencioso
								sintético
				...
				pronome
					...
					tipos de pronomes
						...
						[pronome de tratamento](https://www.todamateria.com.br/pronomes-de-tratamento/)
							Vossa(s) Eminência(s)
								Cardeais.
							...
							Regras
								1)quando nos dirigimos a segunda pessoa(com quem se fala)
									utilizamos o vossa
								2)quando nos dirigimos a terceira pessoa(de quem se fala)
									se utiliza o sua
						possesivos
						desmonstrativos
							[quando usar este ou esss](https://www.todamateria.com.br/quando-usar-este-ou-esse/)
						indefinidos
						relativos
						interrogativos
				palavras invariveis
			...
			[Formação de tempo composto](https://www.todamateria.com.br/formacao-dos-tempos-compostos/)
		Sintaxe
			verbos transitivos
			...
			objeto direto e objeto indireto
				...
				exemplos de objetos diretos e indiretos
					a) "Em vez das mágoas de agora, Eu tinha nessas delícias De minha mãe as carícias E beijos da minha irmã."
					- Objeto direto: "carícias"
					- Objeto indireto: "de minha mãe" e "da minha irmã"
					b) "Este lugar delicioso e triste, cansada de viver, tinha escolhido para morrer a mísera Lindoia."
					- Objeto direto: "a mísera Lindoia."
					c) "Julgando inúteis as cautelas, curvei-me à fatalidade."
					- Objeto direto: "as cautelas"
					- Objeto indireto: "à fatalidade"
					d) "As flores leva-as a brisa."
					- Objeto direto: "As flores"
					- Objeto indireto: "a brisa"
			oração
			...
			concordância verbal e nominal
				concordância verbal
					...
					expressão "um dos que"
						3as ou 3ap
					sujeito composto simples
					   o verbo deve ficar na 3 pessoa do plural
				...
				concordância nominal
					1)substantivo  e adjetivo
						um adjetivo antes do substantivo
						um adjetivo antes de 2 ou mais substantivos
						...
						um adjetivo depois de 2 ou mais substantivos
					...
					3)anexo , bastante , meio menos , é proibido , é bom , é necessário
						anexo , bastante , meio
			...
			regência verbal e nominal
				...
				regência verbal
					...
					[pronome relativo oração adjetiva regência](https://youtu.be/8sLu-UPsQ9Y)
				crase
	...
	ORTOGRAFIA
		[homonimos e paronimos](https://www.todamateria.com.br/homonimos-e-paronimos/)
			**Homógrafas**
			**Homófonas**
			**Perfeitas**
INFORMÁTICA SIN
